...
export default function ExportModal({ isOpen, onClose, onExport, reportType }) {
    ...
    <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.7)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }} onClick={onClose}>
      <div className="card" style={{ width: '90%', maxWidth: 450, maxHeight: '85vh', display: 'flex', flexDirection: 'column' }} onClick={e => e.stopPropagation()}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
          <h3 style={{ margin: 0, fontSize: 18 }}>Select PDF Columns</h3>
        ...
        <div className="btn-group" style={{ justifyContent: 'flex-end', marginTop: 'auto' }}>
          ...
          <button type="button" className="btn btn-primary" onClick={handleExport}>Download PDF</button>
        </div>
      </div>
    </div>
  );
